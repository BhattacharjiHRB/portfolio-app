...
import { bottomVariants, centerVariants, mobileNav, navLinks, topVariants } from '@/utils/motion'
        ...
        <a  href='/' className='h-auto w-auto flex flex-row items-center' >
          ...
          <div className='w-[500px] h-full flex flex-row items-center justify-center md:mr-20'>
            ...
            <div className='block md:hidden ml-5'>
              <button className='w-5 h-8 flex flex-col justify-between z-50 relative' onClick={() => setOpen((prev) => !prev)} >
              <motion.div 
