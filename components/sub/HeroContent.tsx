    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        >
          ...
          <h1 className=" Welcome-text font-bold text-center">
            Frontend Developer{" "}
          </h1>
        </motion.div>
        <motion.div
        ...
        >
          I am experienced frontend developer skilled in HTML, CSS, and
          JavaScript, adept at crafting engaging user interfaces and seamless
          user experiences. Proficient in responsive design and cross-browser
          compatibility, with a keen eye for detail and a passion for creating
          visually appealing websites. Dedicated to staying abreast of industry
